...
<body>
	...
	<form enctype="multipart/form-data" method="post" id="frm"
		action="Sell_EditResult.so?sell_notice_num=${board.sell_notice_num }&pageNum=${currentPage}"
		onsubmit="return insertChk()">
		<!-- 게시글 번호 -->
		<input type="hidden" name="sell_notice_num"
			value="${sell_notice_num }">
		<!-- 아이디 -->
		<input type="hidden" name="id" value="${id }">
		<!-- 작성 날짜 -->
		<input type="hidden" name="sell_notice_reg_date"
			value="${sell_notice_reg_date }">
				...
				<div class="board_write">
					...
					<div class="title">
						<dl>
							<dt>제목</dt>
							<dd>
								<input type="text" name="sell_notice_title"
									id="sell_notice_title" placeholder="글 제목을 입력하세요">
							</dd>
						</dl>
					</div>
					<div class="info">
						<dl>
							<dt>판매금액</dt>
							<dd>
								<input type="text" name="sell_notice_price"
									id="sell_notice_price" placeholder="판매금액을 재시해주세요">
							</dd>
						</dl>
					</div>
					<!--<div class="summernote"> -->
					<textarea id="summernote" name="sell_notice_content" class="clear"></textarea>
					<!-- </div>     -->
					<div class="bt_wrap">
						<div class="back">
