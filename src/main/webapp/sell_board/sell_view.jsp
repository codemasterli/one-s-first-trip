...
<body>
	...
	%>
	<form action="view.so" name="form" method="post">
		<div class="intro_bg">
			<div class="header1">
		...
		<div class="board_wrap">
			...
			<div class="board_view_wrap">
				<div class="btd">
					<div class="del" style="margin-top: -50px;">
						<div class="eff-7"></div>
						<a
							href="/Project2/sell_board/sell_delete.so?sell_notice_num=${board.sell_notice_num}&pageNum=${currentPage}">삭제</a>
					</div>
				</div>
				<div class="board_view">

					<div class="title">${board.sell_notice_title}</div>

					<div class="info">
						<dl>
							<dt>번호</dt>
							<dd>${board.sell_notice_num}</dd>
						</dl>
						<dl>
							<dt>글쓴이</dt>
							<dd>${board.id}</dd>
						...
						<dl>
							<dt>날짜</dt>
							<dd>${board.sell_notice_reg_date}</dd>
						</dl>
						<dl>
							<dt>조회수</dt>
							<dd>${board.sell_notice_read_cnt }</dd>
						</dl>
						<dl>
							<dt>가격</dt>
							<dd>${board.sell_notice_price }</dd>
						</dl>
					</div>
					<img src="/Project2/imgSell/${board.thumbnail}"
						style="width: 80%; margin-top: 30px">
					<div class="cont">${board.sell_notice_content}</div>
							...
							<div class="button_base b03_skewed_slide_in">
								<div>
									<input class="box1" type="button" value="확인"
										onclick="location.href ='/Project2/sell_board/sell_notice.so?sell_notice_num=${board.sell_notice_num }&pageNum=${currentPage}'">
								</div>
								<div></div>
								<div>
							...
							<div class="button_base b03_skewed_slide_in1">
								<div>
									<input class="box2" type="button" value="수정"
										onclick="location.href ='/Project2/sell_board/Sell_EditAction.so?sell_notice_num=${board.sell_notice_num }&pageNum=${currentPage}'">
								</div>
								<div></div>
								<div>
	...
	<%-- <div class="bt_wrap">
					<a href="/Project2/sell_board/sell_notice.so?sell_notice_num=
					${board.sell_notice_num }&pageNum=${currentPage}" class="on">확인</a> 
					<a href="/Project2/sell_board/Sell_EditAction.so?sell_notice_num=
					${board.sell_notice_num }&pageNum=${currentPage}">수정</a>
				</div> --%>
