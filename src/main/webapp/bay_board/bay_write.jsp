...
<script type="text/javascript">
	function insertChk() {
		if ($("input[name=bay_notice_title]").val() == ""
				|| $("input[name=bay_notice_title]").val() == null) {		
	alert("제목 입력란을 작성하세요");
			return false;
		} else if ($("input[name=bay_notice_price]").val() == ""
				|| $("input[name=bay_notice_price]").val() == null) {
			alert("가격 입력란을 작성하세요");
			return false;
...
<body>
	...
	<form enctype="multipart/form-data" method="post" id="frm"
		action="Bay_BoardResult.bo" onsubmit="return insertChk()">
		<!-- 게시글 번호 -->
