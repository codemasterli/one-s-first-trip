...
<img alt="" src="/Project2/images/first.png" style="width: 100px;position: absolute;top: 10px;  right: 900px;"></a>
	...
	<div class="board_wrap">
      ...
      <form action="/Project2/notice/editResult.no?notice_num=${notice_board.notice_num}&pageNum=${currentPage}" method="post" id="frm">
 <input type="hidden" name="notice_num" value="${notice_board.notice_num }"> <input
				type="hidden" name="id" value=${id }> <input type="hidden"
				name="pageNum" value="${pageNum }"> <input type="hidden"
				name="notice_reg_date" value="${notice_board.notice_reg_date }"> 
				<input type="hidden" name="notice_read_cnt" value="${notice_board.notice_read_cnt }">
    <div class="board_wrap">
        <div class="board_write_wrap">
            <div class="board_write">
                <div class="title">
                    ...
                    <dl>
                        <dt>글제목</dt>
                        <dd><input type="text" name="notice_title" id="notice_title" placeholder="글제목을 입력하세요" value="${notice_board.notice_title}"></dd>
                    </dl>
                </div>
                <!--<div class="summernote"> -->
                    <textarea  id="summernote"  name="notice_content" >${notice_board.notice_content }</textarea>
                <!-- </div>     -->   
            <div class="bt_wrap">
            		<div class="back">
...
<!--                 <a onclick="document.getElementById('frm').submit();" id="btn" class="on">수정</a>
