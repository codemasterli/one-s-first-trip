...
var lastID = 0;
   ...
   function chatListFunction(type){
		 ...
		 $.ajax({
			 ...
			 success: function(data){
				 if(data == "") return ; //데이터가 없으면 그냥 보여주는거
   ...
   function addChat(chatName,chatContent,chatTime){
	   $('#chatList').append('<div class="row"' +
			   ...
			   '<img class="media-object img-circle" src="images/man2.png">'+
                 '</a>'+
...
<body>
  <div class="container">
       <div class="container boorstrap snippet">
          <div class="row">
            <div class="col-xs-12">
              <div class="portlet portlet-default">
                ...
                <div id="chat" class="panel-collapse collapse in">
                                                        <!-- overflow-y 는 글이 생길때마다 늘어날수있다 이걸말함 -->
